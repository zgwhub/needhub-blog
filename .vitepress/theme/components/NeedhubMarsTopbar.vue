...
const links = [
  ...
  { key: 'private', text: '私教学习', href: withBase('/needhub-nav/learn#courses') },
  { key: 'more', text: '更多产品', href: withBase('/blog/') }
]
</script>
...
<template>
  <header class="nh-mars-topbar">
    ...
    <nav class="nh-mars-nav" aria-label="NeedHub 编程导航">
      <a
        v-for="link in links"
        :key="link.key"
        :href="link.href"
